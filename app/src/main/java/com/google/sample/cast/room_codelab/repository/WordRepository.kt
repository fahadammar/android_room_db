package com.google.sample.cast.room_codelab.repository

import androidx.annotation.WorkerThread
import com.google.sample.cast.room_codelab.db.Word
import com.google.sample.cast.room_codelab.db.WordDao
...
/**
 * The list of words is a public property. It's initialized by getting the Flow list of words from Room; you can do this
 * because of how you defined the getAlphabetizedWords method to return Flow in the "Observing database changes" step.
 * Room executes all queries on a separate thread.
 */
